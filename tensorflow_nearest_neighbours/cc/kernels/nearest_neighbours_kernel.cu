...
namespace tensorflow {
    namespace functor {
        ...
        namespace {
            __global__ inline int index_2d_flat(int index_0, int index_1, int shape_1) {
                return index_1 + index_0 * shape_1;
            }

            __global__ inline int index_3d_flat(int index_0, int index_1, int index_2, int shape_1, int shape_2) {
