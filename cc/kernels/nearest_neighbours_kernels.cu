...
namespace tensorflow {
  namespace functor {
    ...
    __global__ void NearestNeighboursCudaKernel(
        ...
        const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> eigen_embedding_matrix,
    ...
    struct NearestNeighboursFunctor<T, GPUDevice> {
      ...
      void operator()(
        ...
        NearestNeighboursCudaKernel<float>
